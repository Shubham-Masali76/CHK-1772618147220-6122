...
with hero_left:
    ...
    ">
        ...
        <div style="
            ...
            font-family:'IBM Plex Mono',monospace; font-weight:500; color:#fff;
            box-shadow:0 2px 8px rgba(37,99,235,0.15);
        ">ML</div>
        <div>
            <div style="
...
with hero_right:
    ...
    ">
        <div style="font-size:.925rem;color:{T['muted']};
        ...
        <div style="display:flex;align-items:center;gap:12px;
            ...
            <div>
                ...
                <span style="color:{T['green']};font-weight:700;
                    font-family:'IBM Plex Mono',monospace;">{fname}</span>
                <span style="color:{T['muted']};font-size:.95rem;">
                    &nbsp;·&nbsp;{st.session_state.session_df.shape[0]:,} rows
                    × {st.session_state.session_df.shape[1]} cols</span>
                <br>
                <span style="font-size:.95rem;color:{T['cyan']};
                    font-family:'IBM Plex Mono',monospace;">{progress_str}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    with clear_col:
...
if df is None:
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-top:1.5rem;">
        <div style="background:{T['card']};border:1px solid {T['border']};border-radius:14px;padding:1.2rem 1.4rem;">
            <div style="font-family:'IBM Plex Mono',monospace;font-size:.9rem;color:{T['cyan']};
                text-transform:uppercase;letter-spacing:.1em;margin-bottom:.5rem;">01</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;color:{T['text']};font-size:.9rem;margin-bottom:.3rem;">Smart Analysis</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;color:{T['muted']};font-size:.9rem;line-height:1.6;">Auto-detects column types, missing values, and ML problem type</div>
        </div>
        <div style="background:{T['card']};border:1px solid {T['border']};border-radius:14px;padding:1.2rem 1.4rem;">
            <div style="font-family:'IBM Plex Mono',monospace;font-size:.9rem;color:{T['cyan']};
                text-transform:uppercase;letter-spacing:.1em;margin-bottom:.5rem;">02</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;color:{T['text']};font-size:.9rem;margin-bottom:.3rem;">AI Preprocessing</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;color:{T['muted']};font-size:.9rem;line-height:1.6;">Recommends encoding, scaling, and imputation strategies</div>
        </div>
        <div style="background:{T['card']};border:1px solid {T['border']};border-radius:14px;padding:1.2rem 1.4rem;">
            <div style="font-family:'IBM Plex Mono',monospace;font-size:.9rem;color:{T['cyan']};
                text-transform:uppercase;letter-spacing:.1em;margin-bottom:.5rem;">03</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;color:{T['text']};font-size:.9rem;margin-bottom:.3rem;">Model Tournament</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;color:{T['muted']};font-size:.9rem;line-height:1.6;">Trains multiple models and ranks them by performance</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
...
<div style="display:inline-flex;align-items:center;gap:8px;
    ...
    font-family:'IBM Plex Mono',monospace;font-size:.95rem;color:{T['cyan']};
...
with tab1:
    ...
    def section_label(num, title):
        ...
        <div style="display:flex;align-items:center;gap:10px;
            ...
            font-size:1.15rem;color:{T['text']};">
            <span style="background:linear-gradient(135deg,{T['cyan_dim']},{T['violet_dim']});
                ...
                font-size:.95rem;color:{T['cyan']};letter-spacing:.04em;">{num}</span>
            {title}
    ...
    st.markdown(f"""<p style="color:{T['muted']};font-size:.925rem;margin-bottom:.5rem;">
    ...
    with eda_col1:
        if st.checkbox("Show Distribution of Target Variable"):
            ...
            fig_hist.update_layout(
                ...
                font_family="Plus Jakarta Sans", font_color=T["muted"],
...
with tab2:
    ...
    def step_header(number, title, subtitle=""):
        ...
        <div style="display:flex;align-items:flex-start;gap:14px;
            ...
            <div style="width:32px;height:32px;flex-shrink:0;
                ...
                font-size:.95rem;font-weight:500;color:#fff;">{number}</div>
            <div>
                <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;
                    color:{T['text']};font-size:.95rem;">{title}</div>
                {f'<div style="color:{T["muted"]};font-size:.9rem;margin-top:2px;">{subtitle}</div>' if subtitle else ''}
            </div>
        </div>""", unsafe_allow_html=True)
    ...
    if st.session_state.analysis is not None:
        ...
        <div style="background:{T['card']};border:1px solid {T['border']};
            ...
            font-family:'Plus Jakarta Sans',sans-serif;font-size:.95rem;color:{T['muted']};">
            Dataset contains
        ...
        with col_cat:
            ...
            <div style="background:{T['card']};border:1px solid {T['border']};
                ...
                <div style="color:{T['muted']};font-size:.9rem;text-transform:uppercase;
                    letter-spacing:.1em;font-weight:600;margin-bottom:.6rem;
                    font-family:'Plus Jakarta Sans',sans-serif;">Categorical Columns</div>
            """, unsafe_allow_html=True)
            if analysis["categorical_columns"]:
                for c in analysis["categorical_columns"]:
                    ...
                    <span style="display:inline-block;background:{T['violet_dim']};
                        ...
                        font-size:.95rem;color:{T['violet']};margin:2px 3px;">{c}</span>
                    """, unsafe_allow_html=True)
            else:
        ...
        with col_num:
            ...
            <div style="background:{T['card']};border:1px solid {T['border']};
                ...
                <div style="color:{T['muted']};font-size:.9rem;text-transform:uppercase;
                    letter-spacing:.1em;font-weight:600;margin-bottom:.6rem;
                    font-family:'Plus Jakarta Sans',sans-serif;">Numerical Columns</div>
            """, unsafe_allow_html=True)
            for n in analysis["numerical_columns"]:
                ...
                <span style="display:inline-block;background:{T['cyan_dim']};
                    ...
                    padding:2px 10px;font-family:'IBM Plex Mono',monospace;
                    font-size:.95rem;color:{T['cyan']};margin:2px 3px;">{n}</span>
                """, unsafe_allow_html=True)
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        <div style="display:inline-flex;align-items:center;gap:10px;
            ...
            padding:8px 20px;margin:.8rem 0;font-family:'Plus Jakarta Sans',sans-serif;">
            <span style="color:{T['muted']};font-size:.925rem;">Detected ML Problem:</span>
        ...
        <div style="background:{T['card']};border:1px solid {T['border']};
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.7rem;">
                <span style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;color:{T['text']};">Dataset Readiness</span>
                <span style="font-family:'IBM Plex Mono',monospace;font-size:1.2rem;color:{score_color};">
                    {score}<span style="font-size:.925rem;color:{T['muted']};">/100</span></span>
            </div>
            ...
            <div style="margin-top:.5rem;font-family:'Plus Jakarta Sans',sans-serif;
                font-size:.95rem;color:{score_color};">{readiness['status']}</div>
        </div>""", unsafe_allow_html=True)
        ...
        if readiness["issues"]:
            for issue in readiness["issues"]:
                ...
                <div style="display:flex;align-items:center;gap:8px;color:{T['amber']};
                    font-size:.9rem;font-family:'Plus Jakarta Sans',sans-serif;margin:.2rem 0;">
            ...
            with st.spinner("Preparing data and training models..."):
                ...
                if removed_features:
                    ...
                    <div style="color:{T['amber']};font-size:.925rem;
                        font-family:'Plus Jakarta Sans',sans-serif;margin:.4rem 0;">
                    ...
                    for r in removed_features:
                        ...
                        <span style="display:inline-block;background:{T['amber']}15;
                            ...
                            padding:2px 10px;font-family:'IBM Plex Mono',monospace;
                            font-size:.95rem;color:{T['amber']};margin:2px;">{r}</span>
                        """, unsafe_allow_html=True)
...
with tab3:
    if st.session_state.result is None:
        ...
        <div style="display:flex;flex-direction:column;align-items:center;
            ...
            <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;
                color:{T['text']};font-size:1.2rem;margin-bottom:.5rem;">No results yet</div>
            <div style="color:{T['muted']};font-size:.95rem;font-family:'Plus Jakarta Sans',sans-serif;">
        ...
        with col1:
            st.markdown(f"""<div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;
            ...
            <div style="display:inline-flex;align-items:center;gap:10px;
                ...
                <span style="color:{T['muted']};font-size:.925rem;">Best Model:</span>
        ...
        <div style="background:linear-gradient(135deg,{T['card']},{T['surface']});
            ...
            <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;
                color:{T['text']};font-size:1.15rem;margin-bottom:.5rem;">{explanation['title']}</div>
            <div style="font-family:'Plus Jakarta Sans',sans-serif;color:{T['muted']};
                font-size:.95rem;line-height:1.65;margin-bottom:.8rem;">{explanation['message']}</div>
            <div style="background:{T['cyan_dim']};border:1px solid {T['cyan']}20;
                border-radius:10px;padding:.7rem 1rem;font-size:.9rem;color:{T['cyan']};
                font-family:'Plus Jakarta Sans',sans-serif;line-height:1.6;">{explanation['reason']}</div>
        </div>""", unsafe_allow_html=True)
        ...
        if result["feature_importance"] is not None:
            ...
            <p style="color:{T['muted']};font-size:.925rem;margin-bottom:.8rem;
                font-family:'Plus Jakarta Sans',sans-serif;">
        ...
        st.markdown(f"""
        <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;
            font-size:1.15rem;color:{T['text']};margin-bottom:.3rem;">Live Prediction Tester</div>
        <p style="color:{T['muted']};font-size:.925rem;margin-bottom:1rem;
            font-family:'Plus Jakarta Sans',sans-serif;">
            ...
            with st.form("interactive_prediction_form"):
                ...
                if submit_prediction:
                    ...
                    <div style="background:linear-gradient(135deg,{T['green_dim']},{T['cyan_dim']});
                        ...
                        <div style="color:{T['muted']};font-size:.95rem;text-transform:uppercase;
                            letter-spacing:.1em;font-family:'Plus Jakarta Sans',sans-serif;margin-bottom:.4rem;">
        ...
        st.markdown(f"""
        <div style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;
            font-size:1.15rem;color:{T['text']};margin-bottom:1rem;">Export & Download</div>
        """, unsafe_allow_html=True)
        ...
        with col_d1:
            ...
            <div style="background:{T['card']};border:1px solid {T['border']};
                ...
                <div style="font-family:'Plus Jakarta Sans',sans-serif;color:{T['muted']};
                    font-size:.9rem;margin-bottom:.8rem;line-height:1.6;">
